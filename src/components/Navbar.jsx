...
export default function Navbar({ isHomePage = false }) {
    ...
    // Navigation links - always point to landing page sections
    const navLinks = [
    ...
    return (
        ...
        >
            ...
            {/* Mobile Menu */}
            <div
                className={`lg:hidden fixed top-20 right-0 w-64 h-[calc(100vh-80px)] bg-white shadow-xl transform transition-transform duration-300 ease-in-out ${
